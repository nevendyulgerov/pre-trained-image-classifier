...
def calculates_results_stats(results_dic):
    ...
    for image, labels in results_dic.items():
        if labels[2] == 1:
            # increment matches between pet & classifier labels
            results_stats_dic['n_match'] += 1
            
            if labels[3] == 1:
                # increment number of correctly classified dog breeds
                results_stats_dic['n_correct_breed'] += 1
            
        if labels[3] == 1:
            # increment number of dog images
            results_stats_dic['n_dogs_img'] += 1
            
            if labels[4] == 1:
                # increment number of correctly classified dog images
                results_stats_dic['n_correct_dogs'] += 1
        else:
            # increment number of non dog images
            results_stats_dic['n_notdogs_img'] += 1
            
            if labels[4] == 0:
                # increment number of correctly classified non dog images
